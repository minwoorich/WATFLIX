						...
						.addEventListener(
								...
								function(event) {
									if (event.keyCode === 13) { // enter key
										...
										window.location.href = '/watflix/search-result?keyword='+ keyword;
									}
								});
			</script>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="topbar-filter fw">
							<p>
								Found <span>${fn:length(searchList)} movies</span> in total
							</p>
							<script type="text/javascript">
								var sort = "${sort}";
								$(document)
													...
													$("#sort")
															.change(
																	function() {
																		alert("a dsfa s");
																		//컨트롤러 실행
																		location.href = '/watflix/search-result?sort='
																				+ encodeURI($(
																						this)
																						.val());
