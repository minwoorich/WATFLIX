	...
	<div class="hero user-hero">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="hero-ct">
						<h1>${loginuser.email}’sprofile</h1>
						<ul class="breadcumb">
				...
				<div class="row ipad-width2">
						...
						<div class="user-information">
							<div class="user-img">
								<a href="#"><img src="/watflix/images/uploads/user-img.png"
									height="120px" width="120px" alt=""><br></a> <a href="#"
							...
							<div class="user-fav">
								...
								<ul>
									...
									<li><a
										href="/watflix/user/my-favorite?user_no=${sessionScope.loginuser.user_no }">Favorite
											movies</a></li>
					...
					<div class="col-md-9 col-sm-12 col-xs-12">
						<div class="topbar-filter">
							<p>
								Found <span>${fn:length(myReviewedMovieList)}</span> in total
							</p>

						</div>

						<c:forEach var="movie" items="${myReviewedMovieList}">
							<div class="movie-item-style-2 userrate">
								<img src="${movie.movie_image}" alt="">
								<div class="mv-item-infor">
									<h6>
										<a
											href="/watflix/movie/movie-info?movie_no=${movie.movie_no}&user_no=${sessionScope.loginuser.user_no}">${movie.movie_title}<span>${fn:substring(movie.release_date,0,4)}</span></a>
									</h6>
									...
									<p class="time sm">${fn:substring(movie.reviews[0].review_date,0,10)}</p>
									<p>${movie.reviews[0].review_content}</p>
								</div>
							</div>
						</c:forEach>
